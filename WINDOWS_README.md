...
On Windows, follow the standard [README.md](https://github.com/Rahanesh/gpt-engin/blob/main/README.md), but to set API key do one of:
...
By running gpt-engin you agree to our [ToS](https://github.com/Rahanesh/gpt-engin/TERMS_OF_USE.md).
